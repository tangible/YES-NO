...
void ofxTriangleShape(float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3){
	
	ofxVec3f tn1 = ofxVec3f(x1, y1, z1);
	ofxVec3f tn2 = ofxVec3f(x2, y2, z2);
	ofxVec3f tn3 = ofxVec3f(x3, y3, z3);
	...
	glVertex3f(x2, y2, z2);
	ofxVec3f n3 = tn3.cross(tn1);
	glNormal3f(n3.x, n3.y, n3.z);	
	glTexCoord3f(x3, y3, z3);
	glVertex3f(x3, y3, z3);
	glEnd();
}
void ofxTriangleShape(ofxVec3f pos1, ofxVec3f pos2, ofxVec3f pos3){
