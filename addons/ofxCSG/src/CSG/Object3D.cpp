...
Object3D::Object3D(ofxCSGSolid * solid)
{
	Vertex * v1 = 0;
	Vertex * v2 = 0;
	Vertex * v3 = 0;
...
Object3D::~Object3D()
{
	ofLog(OF_LOG_VERBOSE, "Deleting vertex set");
	delete vertices;
	ofLog(OF_LOG_VERBOSE, "Deleting face set");
	delete faces;
	ofLog(OF_LOG_VERBOSE, "Deleting bound");
	delete bound;
}
...
//						}
					...
					Bound bound1 = face1->getBound();
					Bound bound2 = face2->getBound();
					if(bound1.overlap(bound2))
					{
...
//						}
	...
	ofLog(OF_LOG_VERBOSE, "Num faces at start = %d", numFacesStart);
	ofLog(OF_LOG_VERBOSE, "Num faces at end   = %d", getNumFaces());
